...
pub fn test_roundtrip() {
    ...
    // worksn't
    // let path = "tests/images/valid/openexr/Chromaticities/Rec709_YC.exr"; //
    // subsampling let path =
    // "tests/images/valid/openexr/LuminanceChroma/Flowers.exr"; // subsampling
